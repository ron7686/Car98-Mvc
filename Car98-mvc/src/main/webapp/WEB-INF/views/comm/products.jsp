...
<body>
	...
	<div class="container">
		<div class="contorl  my-2 d-flex justify-content-end">
			...
			<button type="button" class="btn btn-outline-light letter-spacing" data-toggle="modal" data-target="#cart">
				...
				<div class="col-md-3 col-sm-6">
					<div class="product-grid">
						<div class="product-image">
							<a href="<spring:url value='/comm/product?id=${product.bidId}' />"> <img class="pic-1"
									src="<c:url value='comm/picture/${product.bidId}' />" /> <img class="pic-2"
									src="" />
							</a>
						</div>
						<div class="product-content">
							...
							<FORM action="<c:url value='BuyBid.do' />" method="POST">
								...
								<a data-name="${product.bidItemName}" data-price="${product.bidPrice}"
